...
#include "i2c.h"
//
#define MPU6050_ADDR_READ  0xD3	//1101 0011
#define MPU6050_ADDR_WRITE 0xD2	//1101 0010
//
#define i2c_write(a, b, c, d)   HAL_I2C_Mem_Write(&hi2c1, MPU6050_ADDR_WRITE, b, I2C_MEMADD_SIZE_8BIT, d, c, 2)
#define i2c_read(a, b, c, d)    HAL_I2C_Mem_Read(&hi2c1, MPU6050_ADDR_READ, b, I2C_MEMADD_SIZE_8BIT, d, c, 2)
#define delay_ms(n)    HAL_Delay(n)
#define get_ms(n)      do {*n = HAL_GetTick();} while (0)
//
